...
export const messages = {
  zh: {
    ...
    foundation: "工程预览",
    foundationHint: "当前提供桌面基础界面。连接配置将在下一阶段开放。",
    find: "查找记忆",
    query: "搜索关键词",
    search: "查找",
  ...
  en: {
    ...
    foundationHint:
      "This preview provides the desktop shell. Connection setup follows in the next phase.",
    find: "Find memories",
    ...
    nativeReady: "Ready",
    privacy:
      "This preview does not save memory text, search results, or credentials.",
    tip: "A useful habit",
